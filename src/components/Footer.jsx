  ...
  return (
    <footer className='bg-gray-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            <Link to='/'>
              ...
              <h1 className='text-red-500 text-2xl font-bold'>BazarHub</h1>
            </Link>
        ...
        <div>
            ...
            <form action="" className='mt-4 flex'>
                ...
                className='w-full p-2 rounded-l-md  text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 bg-gray-100'
                />
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()} <span className='text-red-500'>BazarHub</span>. All rights reserved</p>
      </div>
    </footer>
  )
}
